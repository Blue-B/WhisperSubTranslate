...
const I18N = {
  ko: {
    ...
    modelTagAsr: '음성',
    modelSpeed: { extreme: '극한 빠름', veryFast: '매우 빠름', fast: '빠름', medium: '보통' },
    ...
    localModel18bOption: 'HY-MT 1.8B · 빠름 (권장)',
    localModel7bOption: 'HY-MT 7B · 고품질',
    localModel18bLabel: 'HY-MT 1.8B · 빠름',
    localModel7bLabel: 'HY-MT 7B · 고품질',
    localReqLabel: 'GPU/CPU 권장',
    ...
    translationChatgptHtml:
      '<strong>GPT-5.4 mini:</strong> 사용자 API 키 필요<br><strong>자연스러운</strong> 번역 가능',
    // 셀렉트 옵션
    ...
    trLocal: 'Local · 오프라인 (HY-MT 1.5 1.8B Q4, 약 1.1 GB)',
    translationLocalHtml:
      '<strong>Local (HY-MT):</strong> 오프라인 번역 · 인터넷 불필요<br>최초 1회 약 1.1 GB 다운로드 · GPU 판어서 장치 선택',
    localModelInstalledHtml: '&#10003; HY-MT 모델 설치됨 (약 1.1 GB)',
    localModelDownloadingHtml: 'HY-MT Q4 다운로드 중...',
    localModelMissingHtml: '⚠ HY-MT 모델 미설치 (약 1.1 GB) — 시작 시 자동 다운로드',
    // SRT 모드 관련
    ...
    allFailed: '⚠️ 모든 번역 실패 — API 키/할당량을 확인하세요',
    allDoneWithErrors: '완료 — 일부 파일 실패 (출력 폴더 확인)',
    localModel18bLabel: 'HY-MT 1.8B · 빠름 (권장)',
    localModel7bLabel: 'HY-MT 7B · 고품질',
    localReqLabel: '권장 사양',
    ...
    openaiHelpHtml:
      '<a href="https://platform.openai.com/api-keys" target="_blank">OpenAI API 키 발급받기</a><br>(GPT-5.4 mini, 유료 - 입력 $0.075 / 출력 $0.60 per 1M 토큰)',
  ...
  en: {
    ...
    modelTagAsr: 'ASR',
    modelSpeed: { extreme: 'Extreme', veryFast: 'Very fast', fast: 'Fast', medium: 'Medium' },
    ...
    localModel18bOption: 'HY-MT 1.8B · Fast (Recommended)',
    localModel7bOption: 'HY-MT 7B · High quality',
    localModel18bLabel: 'HY-MT 1.8B · Fast',
    localModel7bLabel: 'HY-MT 7B · High quality',
    localReqLabel: 'GPU/CPU recommended',
    ...
    translationChatgptHtml:
      '<strong>GPT-5.4 mini:</strong> User API key required<br><strong>Natural</strong> translation possible',
    ...
    trLocal: 'Local · Offline (HY-MT 1.5 1.8B Q4, ~1.1 GB)',
    translationLocalHtml:
      '<strong>Local (HY-MT):</strong> Offline translation · no internet required<br>One-time ~1.1 GB download · GPU/CPU selectable',
    localModelInstalledHtml: '&#10003; HY-MT model installed (~1.1 GB)',
    localModelDownloadingHtml: 'Downloading HY-MT Q4...',
    localModelMissingHtml: '⚠ HY-MT model not installed (~1.1 GB) — auto-downloads on start',
    // SRT mode
    ...
    allFailed: '⚠️ All translations failed — check API key/quota',
    allDoneWithErrors: 'Completed — some files failed (check output folder)',
    localModel18bLabel: 'HY-MT 1.8B · Fast (recommended)',
    localModel7bLabel: 'HY-MT 7B · High quality',
    ...
    openaiHelpHtml:
      '<a href="https://platform.openai.com/api-keys" target="_blank">Get OpenAI API Key</a><br>(GPT-5.4 mini, paid - $0.075 input / $0.60 output per 1M tokens)',
  ...
  ja: {
    ...
    modelTagAsr: '音声',
    modelSpeed: { extreme: '超高速', veryFast: '非常に高速', fast: '高速', medium: '普通' },
    ...
    localModel18bOption: 'HY-MT 1.8B · 高速（推奨）',
    localModel7bOption: 'HY-MT 7B · 高品質',
    localModel18bLabel: 'HY-MT 1.8B · 高速',
    localModel7bLabel: 'HY-MT 7B · 高品質',
    localReqLabel: 'GPU/CPU 推奨',
    ...
    trLocal: 'Local・オフライン (HY-MT 1.5 1.8B Q4、約1.1 GB)',
    translationLocalHtml:
      '<strong>Local (HY-MT):</strong> オフライン翻訳・インターネット不要<br>初回約1.1 GBをダウンロード・GPU/CPU選択可',
    localModelInstalledHtml: '&#10003; HY-MTモデルインストール済み（約1.1 GB）',
    localModelDownloadingHtml: 'HY-MT Q4 ダウンロード中...',
    localModelMissingHtml: '⚠ HY-MTモデル未インストール（約1.1 GB）— 開始時に自動ダウンロード',
    // SRTモード
    ...
    allFailed: '⚠️ すべての翻訳が失敗 — APIキー/割当量を確認',
    allDoneWithErrors: '完了 — 一部ファイルが失敗（出力フォルダを確認）',
    localModel18bLabel: 'HY-MT 1.8B · 高速（推奨）',
    localModel7bLabel: 'HY-MT 7B · 高品質',
    ...
    openaiHelpHtml:
      '<a href="https://platform.openai.com/api-keys" target="_blank">OpenAI API キーを取得</a><br>（GPT-5.4 mini、有料 - 入力 $0.075 / 出力 $0.60 per 1Mトークン）',
  ...
  zh: {
    ...
    modelTagAsr: '语音',
    modelSpeed: { extreme: '极快', veryFast: '非常快', fast: '快', medium: '中等' },
    btnDownloading: '下载中…',
    btnCancel: '取消',
    btnDeleting: '删除中…',
    ...
    localModel18bOption: 'HY-MT 1.8B · 快速（推荐）',
    localModel7bOption: 'HY-MT 7B · 高质量',
    localModel18bLabel: 'HY-MT 1.8B · 快速',
    localModel7bLabel: 'HY-MT 7B · 高质量',
    localReqLabel: '推荐 GPU/CPU',
    ...
    trLocal: 'Local · 离线（HY-MT 1.5 1.8B Q4，约1.1 GB）',
    translationLocalHtml: '<strong>Local (HY-MT):</strong> 离线翻译·无需联网<br>首次约1.1 GB下载·GPU/CPU可选',
    localModelInstalledHtml: '&#10003; HY-MT模型已安装（约1.1 GB）',
    localModelDownloadingHtml: '正在下载 HY-MT Q4...',
    localModelMissingHtml: '⚠ HY-MT模型未安装（约1.1 GB）— 启动时自动下载',
    // SRT模式
    ...
    allFailed: '⚠️ 所有翻译失败 — 请检查API密钥/配额',
    allDoneWithErrors: '完成 — 部分文件失败（请检查输出文件夹）',
    localModel18bLabel: 'HY-MT 1.8B · 快速（推荐）',
    localModel7bLabel: 'HY-MT 7B · 高品质',
    localReqLabel: '推荐配置',
    ...
    openaiHelpHtml:
      '<a href="https://platform.openai.com/api-keys" target="_blank">获取 OpenAI API 密钥</a><br>（GPT-5.4 mini，付费 - 输入 $0.075 / 输出 $0.60 每1M令牌）',
    queueEmpty: '拖拽文件添加',
    soundLabel: '提示音',
    soundTest: '测试',
    settingsBtn: '设置',
  ...
  pl: {
    ...
    modelTagTranslation: 'MT',
    modelTagAsr: 'ASR',
    modelSpeed: { extreme: 'Ekstremalna', veryFast: 'Bardzo szybka', fast: 'Szybka', medium: 'Średnia' },
    ...
    localModel18bOption: 'HY-MT 1.8B · Szybki (Zalecany)',
    localModel7bOption: 'HY-MT 7B · Wysoka jakość',
    localModel18bLabel: 'HY-MT 1.8B · Szybki',
    localModel7bLabel: 'HY-MT 7B · Wysoka jakość',
    localReqLabel: 'Zalecane GPU/CPU',
    ...
    translationChatgptHtml:
      '<strong>GPT-5.4 mini:</strong> Wymagany klucz API użytkownika<br><strong>Naturalne</strong> tłumaczenie',
    ...
    trLocal: 'Local · Offline (HY-MT 1.5 1.8B Q4, ok. 1.1 GB)',
    translationLocalHtml:
      '<strong>Local (HY-MT):</strong> Tłumaczenie offline · bez internetu<br>Jednorazowe pobranie ok. 1.1 GB · wybór GPU/CPU',
    localModelInstalledHtml: '&#10003; Model HY-MT zainstalowany (ok. 1.1 GB)',
    localModelDownloadingHtml: 'Pobieranie HY-MT Q4...',
    localModelMissingHtml: '⚠ Model HY-MT nie zainstalowany (ok. 1.1 GB) — auto-pobiera się przy starcie',
    ...
    allFailed: '⚠️ Wszystkie tłumaczenia nie powiodły się — sprawdź klucz API/limit',
    allDoneWithErrors: 'Zakończono — niektóre pliki nie powiodły się (sprawdź folder wyjściowy)',
    localModel18bLabel: 'HY-MT 1.8B · Szybko (zalecane)',
    localModel7bLabel: 'HY-MT 7B · Wysoka jakość',
    ...
    openaiHelpHtml:
      '<a href="https://platform.openai.com/api-keys" target="_blank">Uzyskaj klucz API OpenAI</a><br>(GPT-5.4 mini, płatny - $0.075 wejście / $0.60 wyjście na 1M tokenów)',
