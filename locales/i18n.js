...
const I18N = {
  ko: {
    ...
    translationLocalHtml: "<strong>Local (HY-MT):</strong> 오프라인 번역 · 인터넷 불필요<br>최초 1회 약 1.1 GB 다운로드 · GPU 판어서 장치 선택",
  ...
  en: {
    ...
    translationLocalHtml: "<strong>Local (HY-MT):</strong> Offline translation · no internet required<br>One-time ~1.1 GB download · GPU/CPU selectable",
  ...
  ja: {
    ...
    translationLocalHtml: "<strong>Local (HY-MT):</strong> オフライン翻訳・インターネット不要<br>初回約1.1 GBをダウンロード・GPU/CPU選択可",
  ...
  pl: {
    ...
    translationLocalHtml: "<strong>Local (HY-MT):</strong> Tłumaczenie offline · bez internetu<br>Jednorazowe pobranie ok. 1.1 GB · wybór GPU/CPU",
