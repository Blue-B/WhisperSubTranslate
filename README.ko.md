...
로컬에서 동영상의 음성을 인식해 SRT 자막을 만들고, 원하는 언어로 번역하는 Windows 데스크톱 앱입니다. 추출은 whisper.cpp로 빠르고 안정적으로 처리되며, 번역은 MyMemory(무료), DeepL, GPT-5-nano(OpenAI), Gemini를 선택할 수 있습니다.
...
| 번역(선택) | DeepL API, OpenAI(GPT-5-nano), Gemini, MyMemory |
...
### 번역 대상 언어 (13개)
한국어 (ko), 영어 (en), 일본어 (ja), 중국어 (zh), 스페인어 (es), 프랑스어 (fr), 독일어 (de), 이탈리아어 (it), 포르투갈어 (pt), 러시아어 (ru), 헝가리어 (hu), 아랍어 (ar), **폴란드어 (pl)**
